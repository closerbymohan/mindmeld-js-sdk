...
}),this.errback(function(){e.call(t,!1)})},encode:function(e){return this._xhr.encode(e)},request:function(e){this._xhr.request(e)}}),{isUsable:function(e,t,n,s){var i=e._clientId;return i?void Faye.Transport.XHR.isUsable(e,t,function(i){return i?void this.create(e,t).isUsable(n,s):n.call(s,!1)},this):n.call(s,!1)},create:function(e,t){var n=e.transports.eventsource=e.transports.eventsource||{},s=e._clientId;t=Faye.copyObject(t),t.pathname+="/"+(s||"");var i=Faye.URI.stringify(t);return n[i]=n[i]||new this(e,t),n[i]}}),Faye.extend(Faye.Transport.EventSource.prototype,Faye.Deferrable),Faye.Transport.register("eventsource",Faye.Transport.EventSource),Faye.Transport.XHR=Faye.extend(Faye.Class(Faye.Transport,{encode:function(e){var t=Faye.map(e,function(e){return e.message});return Faye.toJSON(t)},request:function(e){var t=this.endpoint.path,n=Faye.ENV.ActiveXObject?new ActiveXObject("Microsoft.XMLHTTP"):new XMLHttpRequest,s=this;n.open("POST",t,!0),n.setRequestHeader("Content-Type","application/json"),n.setRequestHeader("Pragma","no-cache"),n.setRequestHeader("X-Requested-With","XMLHttpRequest");var i=this._client.headers;for(var r in i)i.hasOwnProperty(r)&&n.setRequestHeader(r,i[r]);var o=function(){n.abort()};Faye.Event.on(Faye.ENV,"beforeunload",o),n.onreadystatechange=function(){if(n&&4===n.readyState){var t=null,i=n.status,r=n.responseText,a=i>=200&&300>i||304===i||1223===i;if(Faye.Event.detach(Faye.ENV,"beforeunload",o),n.onreadystatechange=function(){},n=null,!a)return s.handleError(e);try{t=JSON.parse(r)}catch(c){}t?s.receive(e,t):s.handleError(e)}},n.send(this.encode(e))}}),{isUsable:function(e,t,n,s){n.call(s,Faye.URI.isSameOrigin(t))}}),Faye.Transport.register("long-polling",Faye.Transport.XHR),Faye.Transport.CORS=Faye.extend(Faye.Class(Faye.Transport,{encode:function(e){var t=Faye.map(e,function(e){return e.message});return"message="+encodeURIComponent(Faye.toJSON(t))},request:function(e){var t,n=Faye.ENV.XDomainRequest?XDomainRequest:XMLHttpRequest,s=new n,i=this._client.headers,r=this;if(s.open("POST",Faye.URI.stringify(this.endpoint),!0),s.setRequestHeader){s.setRequestHeader("Pragma","no-cache");for(t in i)i.hasOwnProperty(t)&&s.setRequestHeader(t,i[t])}var o=function(){return s?(s.onload=s.onerror=s.ontimeout=s.onprogress=null,void(s=null)):!1};s.onload=function(){var t=null;try{t=JSON.parse(s.responseText)}catch(n){}o(),t?r.receive(e,t):r.handleError(e)},s.onerror=s.ontimeout=function(){o(),r.handleError(e)},s.onprogress=function(){},s.send(this.encode(e))}}),{isUsable:function(e,t,n,s){if(Faye.URI.isSameOrigin(t))return n.call(s,!1);if(Faye.ENV.XDomainRequest)return n.call(s,t.protocol===Faye.ENV.location.protocol);if(Faye.ENV.XMLHttpRequest){var i=new Faye.ENV.XMLHttpRequest;return n.call(s,void 0!==i.withCredentials)}return n.call(s,!1)}}),Faye.Transport.register("cross-origin-long-polling",Faye.Transport.CORS),Faye.Transport.JSONP=Faye.extend(Faye.Class(Faye.Transport,{encode:function(e){var t=Faye.map(e,function(e){return e.message}),n=Faye.copyObject(this.endpoint);return n.query.message=Faye.toJSON(t),n.query.jsonp="__jsonp"+Faye.Transport.JSONP._cbCount+"__",Faye.URI.stringify(n)},request:function(e){var t=Faye.map(e,function(e){return e.message}),n=document.getElementsByTagName("head")[0],s=document.createElement("script"),i=Faye.Transport.JSONP.getCallbackName(),r=Faye.copyObject(this.endpoint),o=this;r.query.message=Faye.toJSON(t),r.query.jsonp=i,Faye.ENV[i]=function(t){if(!Faye.ENV[i])return!1;Faye.ENV[i]=void 0;try{delete Faye.ENV[i]}catch(n){}s.parentNode.removeChild(s),o.receive(e,t)},s.type="text/javascript",s.src=Faye.URI.stringify(r),n.appendChild(s)}}),{_cbCount:0,getCallbackName:function(){return this._cbCount+=1,"__jsonp"+this._cbCount+"__"},isUsable:function(e,t,n,s){n.call(s,!0)}}),Faye.Transport.register("callback-polling",Faye.Transport.JSONP),Faye}(),MM=function(e,t,n){var s=e.MM=e.MM||{};return Object.defineProperty(s,"version",{value:"2.4.0",writable:!1}),s.config={cleanUrl:"https://mindmeldv2.expectlabs.com/",fayeClientUrl:"https://push-west-prod-a.expectlabs.com:443/faye"},s.Internal=t.extend({},{setup:function(){s.activeSessionId=null,s.activeUserId=null},onReady:function(){s.Internal.initializeModels(),s.Internal.EventHandler.init(s.config.fayeClientUrl),s.Util.testAndCall(s.config.onInit)},initializeModels:function(){t.extend(s,new s.models.App),s.documents=new s.models.AppDocumentList,s.activeUser=new s.models.ActiveUser,s.activeUser.sessions=new s.models.SessionList,s.activeSession=new s.models.ActiveSession,s.activeSession.textentries=new s.models.TextEntryList,s.activeSession.entities=new s.models.EntityList,s.activeSession.articles=new s.models.ArticleList,s.activeSession.documents=new s.models.SessionDocumentList,s.activeSession.activities=new s.models.ActivityList,s.activeSession.liveusers=new s.models.LiveUserList,s.activeSession.invitedusers=new s.models.InvitedUserList},clearUserData:function(){s.activeUser.clearAllData(),s.activeUser.sessions.clearAllData()},clearSessionData:function(){s.activeSession.clearAllData(),s.activeSession.textentries.clearAllData(),s.activeSession.entities.clearAllData(),s.activeSession.articles.clearAllData(),s.activeSession.documents.clearAllData(),s.activeSession.activities.clearAllData(),s.activeSession.liveusers.clearAllData(),s.activeSession.invitedusers.clearAllData()},override:function(e,n){t.extend(e.prototype,n)},createSubclass:function(e,t){var n,i=Object.prototype.constructor,r=t.constructor,o=function(){},a=e.prototype;return o.prototype=a,n=r.prototype=new o,n.constructor=r,r.superclass=a,a.constructor===i&&(a.constructor=e),n.superclass=n.supr=function(){return a},n.proto=n,s.Internal.override(r,t),r},log:function(t){e.console&&e.console.log(t)},EventHandler:{fayeClient:null,fayeSubscriptions:{},namedEventHandlers:{},appChannelHandlers:{},userChannelHandlers:{},sessionChannelHandlers:{},init:function(e){this.fayeClient=new n.Client(e,{timeout:120});var t={outgoing:function(e,t){return"/meta/subscribe"!==e.channel?t(e):(e.ext||(e.ext={}),e.ext.authToken=s.token,void t(e))}};this.fayeClient.addExtension(t)},subscribe:function(e,t,n){var i=s.Internal.EventHandler,r=e.channelConfig.channel,o=e.channelConfig.type,a=!0;if(void 0===this.fayeSubscriptions[r]){a=!1;var c=function(e){switch(void 0!==i.namedEventHandlers[r]&&s.Util.testAndCall(i.namedEventHandlers[r][e.event],e.payload),o){case"app":s.Util.testAndCall(i.appChannelHandlers[r],e);break;case"session":s.Util.testAndCall(i.sessionChannelHandlers[r],e);break;case"user":s.Util.testAndCall(i.userChannelHandlers[r],e)}},l=i.fayeClient.subscribe(r,c);i.fayeSubscriptions[r]=l,l.then(function(){s.config.debug&&s.Internal.log("SUCCESSFULLY CONNECTED TO CHANNEL: "+e.channel),s.Util.testAndCall(t)},function(t){s.Internal.log("COULD NOT CONNECT TO CHANNEL: "+e.channel+". Error: "+t.message),s.Util.testAndCall(n,t)})}a&&s.Util.testAndCall(t,r);var u=e.handler;if(e.subscribeAll)switch(o){case"app":i.appChannelHandlers[r]=u;break;case"session":i.sessionChannelHandlers[r]=u;break;case"user":i.userChannelHandlers[r]=u}else void 0===i.namedEventHandlers[r]&&(i.namedEventHandlers[r]={}),i.namedEventHandlers[r][e.name]=u},unsubscribe:function(e){var n=s.Internal.EventHandler,i=e.channelConfig.channel,r=e.channelConfig.type;if(e.subscribeAll)switch(r){case"app":delete n.appChannelHandlers[i];break;case"session":delete n.sessionChannelHandlers[i];break;case"user":delete n.userChannelHandlers[i]}else void 0!==this.namedEventHandlers[i]&&(delete n.namedEventHandlers[i][e.name],t.isEmptyObject(n.namedEventHandlers[i])&&delete n.namedEventHandlers[i]);var o=!1,a=void 0!==n.namedEventHandlers[i];if(!a)switch(r){case"app":o=void 0===n.appChannelHandlers[i];break;case"session":o=void 0===n.sessionChannelHandlers[i];break;case"user":o=void 0===n.userChannelHandlers[i]}if(o){var c=n.fayeSubscriptions[i];c&&(c.cancel(),delete this.fayeSubscriptions[i])}},clearAllEventsForChannel:function(e,t){var n=s.Internal.EventHandler;switch(delete n.namedEventHandlers[e],t){case"app":delete n.appChannelHandlers[e];break;case"session":delete n.sessionChannelHandlers[e];break;case"user":delete n.userChannelHandlers[e]}var i=n.fayeSubscriptions[e];i&&(i.cancel(),delete n.fayeSubscriptions[e]),s.config.debug&&s.Internal.log("Cleared all event handlers on "+e+" channel")}},customEventHandlers:{_publish:function(e,t){var n={name:e,payload:t},s=this.path()+"/events";this.makeModelRequest("POST",s,n)},_subscribe:function(e,t,n,i){var r={name:e,handler:t,subscribeAll:!1};r.channelConfig=this.getChannelConfig(),s.Internal.EventHandler.subscribe(r,n,i)},_unsubscribe:function(e){var t={name:e,subscribeAll:!1};t.channelConfig=this.getChannelConfig(),s.Internal.EventHandler.unsubscribe(t)},_subscribeAll:function(e,t,n){var i={subscribeAll:!0,handler:e};i.channelConfig=this.getChannelConfig(),s.Internal.EventHandler.subscribe(i,t,n)},_unsubscribeAll:function(){var e={subscribeAll:!0};e.channelConfig=this.getChannelConfig(),s.Internal.EventHandler.unsubscribe(e)}}}),t.extend(s,{init:function(n){var i=s.config;s.config=t.extend({},i,n),t(e.document).ready(function(){s.Internal.onReady()})},getToken:function(e,t,n){function i(e){e.data&&e.data.token?(s.token=e.data.token,o?s.get(null,function(n){var i=n.data.ownerid;s.setActiveUserID(i),s.Util.testAndCall(t,e.data)},function(e){s.Util.testAndCall(n,e)}):e.data.user&&e.data.user.userid&&(s.setActiveUserID(e.data.user.userid),s.Util.testAndCall(t,e.data))):s.Util.testAndCall(n,e)}var r={"X-MindMeld-Appid":s.config.appid},o=!1,a=null;if(e.facebook||e.anonymous)a={credentials:e},a=JSON.stringify(a);else if(e.appsecret&&e.simple)r["X-MindMeld-Appsecret"]=e.appsecret,a={credentials:{simple:e.simple}},a=JSON.stringify(a);else{if(!e.appsecret){var c={code:14,type:"CredentialsInvalid",message:"A valid appsecret or either simple or facebook credentials are required."};return void s.Util.testAndCall(n,c)}r["X-MindMeld-Appsecret"]=e.appsecret,o=!0}s.callApi("POST","tokens",a,i,n,r)},revokeToken:function(e,t){function n(n){s.config.debug&&s.Internal.log("SUCCESSFULLY REVOKED TOKEN: "+s.token),s.token="",n.data?s.Util.testAndCall(e,n):s.Util.testAndCall(t,n)}s.callApi("DELETE","token/"+s.token,null,n,t)},setActiveSessionID:function(e,t,n){var i=s.config.appid+"/session/"+s.activeSessionId;s.Internal.EventHandler.clearAllEventsForChannel(i,"session"),s.activeSessionId=e,s.Internal.clearSessionData(),s.activeSession.get(null,t,n)},setActiveSession:function(e,t,n){s.setActiveSessionID(e,t,n)},setActiveUserID:function(e,t,n){var i=s.config.appid+"/user/"+s.activeUserId;s.Internal.EventHandler.clearAllEventsForChannel(i,"user"),s.activeUserId=e,s.Internal.clearUserData(),s.activeUser.get(null,t,n)},setActiveUser:function(e,t,n){s.setActiveUserID(e,t,n)},setToken:function(e,t,n){s.token=e,s.get(null,function(){s.Util.testAndCall(t)},function(){s.Util.testAndCall(n)})},callApi:function(e,n,i,r,o,a){var c=!1;i&&i["if-modified-since"]&&(c=!0,delete i["if-modified-since"]),a=a||{"X-MINDMELD-ACCESS-TOKEN":s.token};var l=s.config.cleanUrl+n;s.config.debug&&s.Internal.log("Calling MindMeld API with: "+e+" and URL: "+l+" and Params: "+JSON.stringify(i)),t.ajax({type:e,url:l,data:i,dataType:"json",headers:a,ifModified:c,success:function(e,t){s.config.debug&&s.Internal.log("The MindMeld request returned: "+JSON.stringify(e)),"notmodified"===t?s.Util.testAndCall(o,t):e?e.data?s.Util.testAndCall(r,e):e.error&&s.Util.testAndCall(o,e.error):s.Util.testAndCall(o,e)},error:function(e,t,n){var i="Ajax Request Error: XMLHTTPRequestObject status: ("+e.status+", "+e.statusText+"), text status: ("+t+"), error thrown: ("+n+")";s.Internal.log("The MindMeld AJAX request failed with the error: "+i),s.Internal.log(e.responseText),s.Internal.log(e.getAllResponseHeaders());var r={code:0,type:"Failed Ajax Request",message:""+n};s.Util.testAndCall(o,r)}})}}),s.models={},s.models.Model=s.Internal.createSubclass(Object,{constructor:function(){this.result=null,this.shouldPersist=!0,this.updateHandler=null,this.eTag=null},backupData:function(){s.support.localStorage&&(e.localStorage[this.localStoragePath()]=JSON.stringify(this.result))},clearAllData:function(){this.result=null,this.clearLocalData()},clearLocalData:function(){s.support.localStorage&&e.localStorage.removeItem(this.localStoragePath())},_get:function(e,t,n){function i(e){s.Util.testAndCall(r,e),s.Util.testAndCall(t,e)}this.makeModelRequest("GET",this.path(),e,i,n);var r=this.updateHandler},restore:function(t,n){if(s.support.localStorage){var i=e.localStorage[this.localStoragePath()];if(i&&(i=JSON.parse(i)))return this.result=i,void s.Util.testAndCall(t)}s.Util.testAndCall(n)},_json:function(){return this.result&&this.result.data?this.result.data:null},makeModelRequest:function(e,t,n,i,r){var o=this,a=function(e){e.request&&e.request.method&&"GET"===e.request.method.toUpperCase()&&(o.result=e,o.shouldPersist&&o.backupData(),e.etag&&(o.eTag=e.etag)),e.data?s.Util.testAndCall(i,e):s.Util.testAndCall(r,e)},c={"X-MINDMELD-ACCESS-TOKEN":s.token};n&&n["if-none-match"]&&null!==this.eTag&&(c["if-none-match"]=this.eTag,delete n["if-none-match"]),s.callApi(e,t,n,a,r,c)},getChannelConfig:function(){var e={},t="/"+s.config.appid;switch(this.channelType){case"app":e.type=this.channelType,e.channel=t;break;case"session":e.type=this.channelType,e.channel=t+"/session/"+s.activeSessionId;break;case"user":e.type=this.channelType,e.channel=t+"/user/"+s.activeUserId}return e},_onUpdate:function(e,t,n){if(this.updateHandler=e,this.updateEventName&&this.channelType){var i={name:this.updateEventName,subscribeAll:!1};if(i.channelConfig=this.getChannelConfig(),e){var r=this;i.handler=function(){r.get()},s.Internal.EventHandler.subscribe(i,t,n)}else s.Internal.EventHandler.unsubscribe(i)}else s.Util.testAndCall(n)},localStoragePath:function(){return""},path:function(){return""}}),s.models.App=s.Internal.createSubclass(s.models.Model,{constructor:function(){s.models.App.superclass.constructor.apply(this,arguments),t.extend(this,s.Internal.customEventHandlers)},localStoragePath:function(){return"MM.app"},path:function(){return""},json:function(){return this._json()},onUpdate:function(e){this._onUpdate(e,null,null)},get:function(e,t,n){this._get(null,t,n)},post:function(e,t,n){this.makeModelRequest("POST",this.path(),e,t,n)},publish:function(e,t){this._publish(e,t)},subscribe:function(e,t,n,s){this._subscribe(e,t,n,s)},unsubscribe:function(e){this._unsubscribe(e)},subscribeAll:function(e,t,n){this._subscribeAll(e,t,n)},unsubscribeAll:function(){this._unsubscribeAll()},channelType:"app"}),s.models.ActiveUser=s.Internal.createSubclass(s.models.Model,{constructor:function(){s.models.ActiveUser.superclass.constructor.apply(this,arguments),t.extend(this,s.Internal.customEventHandlers)},localStoragePath:function(){return"MM.activeUser"},path:function(){return"user/"+s.activeUserId},json:function(){return this._json()},onUpdate:function(e){this._onUpdate(e,null,null)},get:function(e,t,n){this._get(null,t,n)},post:function(e,t,n){this.makeModelRequest("POST",this.path(),e,t,n)},publish:function(e,t){this._publish(e,t)},subscribe:function(e,t,n,s){this._subscribe(e,t,n,s)},unsubscribe:function(e){this._unsubscribe(e)},subscribeAll:function(e,t,n){this._subscribeAll(e,t,n)},unsubscribeAll:function(){this._unsubscribeAll()},channelType:"user"}),s.models.SessionList=s.Internal.createSubclass(s.models.Model,{constructor:function(){s.models.SessionList.superclass.constructor.apply(this,arguments)},localStoragePath:function(){return"MM.activeUser.sessions"},path:function(){return"user/"+s.activeUserId+"/sessions"},json:function(){return this._json()},onUpdate:function(e,t,n){this._onUpdate(e,t,n)},get:function(e,t,n){this._get(e,t,n)},post:function(e,t,n){this.makeModelRequest("POST",this.path(),e,t,n)},"delete":function(e,t,n){this.makeModelRequest("DELETE","session/"+e,null,t,n)},channelType:"user",updateEventName:"sessionsUpdate"}),s.models.TextEntryList=s.Internal.createSubclass(s.models.Model,{constructor:function(){s.models.TextEntryList.superclass.constructor.apply(this,arguments)},localStoragePath:function(){return"MM.activeSession.textentries"},path:function(){return"session/"+s.activeSessionId+"/textentries"},json:function(){return this._json()},onUpdate:function(e,t,n){this._onUpdate(e,t,n)},get:function(e,t,n){this._get(e,t,n)},post:function(e,t,n){this.makeModelRequest("POST",this.path(),e,t,n)},"delete":function(e,t,n){this.makeModelRequest("DELETE","textentry/"+e,null,t,n)},channelType:"session",updateEventName:"textentriesUpdate"}),s.models.EntityList=s.Internal.createSubclass(s.models.Model,{constructor:function(){s.models.EntityList.superclass.constructor.apply(this,arguments)},localStoragePath:function(){return"MM.activeSession.entities"},path:function(){return"session/"+s.activeSessionId+"/entities"},json:function(){return this._json()},onUpdate:function(e,t,n){this._onUpdate(e,t,n)},get:function(e,t,n){this._get(e,t,n)},post:function(e,t,n){this.makeModelRequest("POST",this.path(),e,t,n)},"delete":function(e,t,n){this.makeModelRequest("DELETE","entity/"+e,null,t,n)},channelType:"session",updateEventName:"entitiesUpdate"}),s.models.ArticleList=s.Internal.createSubclass(s.models.Model,{constructor:function(){s.models.ArticleList.superclass.constructor.apply(this,arguments)},localStoragePath:function(){return"MM.activeSession.articles"},path:function(){return"session/"+s.activeSessionId+"/articles"},json:function(){return this._json()},onUpdate:function(e){this._onUpdate(e,null,null)},get:function(e,t,n){this._get(e,t,n)}}),s.models.SessionDocumentList=s.Internal.createSubclass(s.models.Model,{constructor:function(){s.models.SessionDocumentList.superclass.constructor.apply(this,arguments)},localStoragePath:function(){return"MM.activeSession.documents"},path:function(){return"session/"+s.activeSessionId+"/documents"},json:function(){return this._json()},onUpdate:function(e){this._onUpdate(e,null,null)},get:function(e,t,n){this._get(e,t,n)},channelType:"session",updateEventName:"documentsUpdate"}),s.models.AppDocumentList=s.Internal.createSubclass(s.models.Model,{constructor:function(){s.models.AppDocumentList.superclass.constructor.apply(this,arguments)},localStoragePath:function(){return"MM.documents"},path:function(){return"documents"},json:function(){return this._json()},onUpdate:function(e){this._onUpdate(e,null,null)},get:function(e,t,n){this._get(e,t,n)},post:function(e,t,n){this.makeModelRequest("POST",this.path(),e,t,n)},"delete":function(e,t,n){this.makeModelRequest("DELETE","document/"+e,null,t,n)}}),s.models.LiveUserList=s.Internal.createSubclass(s.models.Model,{constructor:function(){s.models.LiveUserList.superclass.constructor.apply(this,arguments)},localStoragePath:function(){return"MM.activeSession.liveusers"},path:function(){return"session/"+s.activeSessionId+"/liveusers"},json:function(){return this._json()},onUpdate:function(e,t,n){this._onUpdate(e,t,n)},get:function(e,t,n){this._get(e,t,n)},post:function(e,t,n){this.makeModelRequest("POST",this.path(),e,t,n)},"delete":function(e,t,n){this.makeModelRequest("DELETE",this.path()+"/"+e,null,t,n)},channelType:"session",updateEventName:"liveusersUpdate"}),s.models.InvitedUserList=s.Internal.createSubclass(s.models.Model,{constructor:function(){s.models.InvitedUserList.superclass.constructor.apply(this,arguments)},localStoragePath:function(){return"MM.activeSession.invitedusers"},path:function(){return"session/"+s.activeSessionId+"/invitedusers"},json:function(){return this._json()},onUpdate:function(e,t,n){this._onUpdate(e,t,n)},get:function(e,t,n){this._get(e,t,n)},post:function(e,t,n){this.makeModelRequest("POST",this.path(),e,t,n)},"delete":function(e,t,n){this.makeModelRequest("DELETE",this.path()+"/"+e,null,t,n)},channelType:"session",updateEventName:"invitedusersUpdate"}),s.models.ActivityList=s.Internal.createSubclass(s.models.Model,{constructor:function(){s.models.ActivityList.superclass.constructor.apply(this,arguments)},localStoragePath:function(){return"MM.activeSession.activities"},path:function(){return"session/"+s.activeSessionId+"/activities"},json:function(){return this._json()},onUpdate:function(e,t,n){this._onUpdate(e,t,n)},get:function(e,t,n){this._get(e,t,n)},post:function(e,t,n){this.makeModelRequest("POST",this.path(),e,t,n)},"delete":function(e,t,n){this.makeModelRequest("DELETE","activity/"+e,null,t,n)},channelType:"session",updateEventName:"activitiesUpdate"}),s.models.ActiveSession=s.Internal.createSubclass(s.models.Model,{constructor:function(){function n(){var t="";return""!==o.lang?t=o.lang:"undefined"!=typeof e.document&&null!==e.document.documentElement&&""!==e.document.documentElement.lang&&(t=e.document.documentElement.lang),t}function i(e){var t={text:e,type:"speech",weight:1},i=n();i.length&&(t.language=s.Listener.convertLanguageToISO6392(i)),r.textentries.post(t,function(e){s.Util.testAndCallThis(r._onTextEntryPosted,r.listener,e)})}s.models.ActiveSession.superclass.constructor.apply(this,arguments);var r=this,o=this.listener=new s.Listener({interimResults:!0,onResult:function(e,t,n,o){e.final&&i(e.transcript),s.Util.testAndCallThis(r._onListenerResult,r.listener,e,t,n,o)},onStart:function(e){s.Util.testAndCallThis(r._onListenerStart,r.listener,e)},onEnd:function(e){var t=this.results,n=null;t.length>0&&(n=t[t.length-1],n.final||i(n.transcript)),s.Util.testAndCallThis(r._onListenerEnd,r.listener,e)},onError:function(e){s.Util.testAndCallThis(r._onListenerError,r.listener,e)}});t.extend(this,s.Internal.customEventHandlers)},localStoragePath:function(){return"MM.activeSession"},path:function(){return"session/"+s.activeSessionId},json:function(){return this._json()},onUpdate:function(e){this._onUpdate(e,null,null)},setListenerConfig:function(e){var t={onResult:"_onListenerResult",onStart:"_onListenerStart",onEnd:"_onListenerEnd",onError:"_onListenerError",onTextEntryPosted:"_onTextEntryPosted"};for(var n in t)e.hasOwnProperty(n)&&(this[t[n]]=e[n],delete e[n]);this.listener.setConfig(e)},get:function(e,t,n){this._get(null,t,n)},post:function(e,t,n){this.makeModelRequest("POST",this.path(),e,t,n)},publish:function(e,t){this._publish(e,t)},subscribe:function(e,t,n,s){this._subscribe(e,t,n,s)},unsubscribe:function(e){this._unsubscribe(e)},subscribeAll:function(e,t,n){this._subscribeAll(e,t,n)},unsubscribeAll:function(){this._unsubscribeAll()},channelType:"session"}),s.Util=t.extend({},{testAndCall:function(e){if(t.isFunction(e)){var n=Array.prototype.slice.call(arguments,1);e.apply(this,n)}},testAndCallThis:function(e,n){if(t.isFunction(e)){var s=Array.prototype.slice.call(arguments,2);e.apply(n,s)}}}),s.Listener=function(){var t=s.Internal.createSubclass(Object,{constructor:function(e){this.setConfig(e)},setConfig:function(e){var t={onResult:"_onResult",onStart:"_onStart",onEnd:"_onEnd",onError:"_onError",onTextEntryPosted:"_onTextEntryPosted",continuous:"continuous",interimResults:"interimResults",lang:"lang"};for(var n in t)e.hasOwnProperty(n)&&(this[t[n]]=e[n])},_lastStartTime:0,start:function(){function t(){e.clearTimeout(i),i=e.setTimeout(function(){r.abort()},2e3)}if(!s.support.speechRecognition)throw s.Internal.log("Speech recognition is not supported"),new Error("Speech recognition is not supported");var n=this;if(!(Date.now()-n._lastStartTime<1e3)){var i=0,r=this._recognizer;"undefined"==typeof r&&(r=this._recognizer=new e.SpeechRecognition,r.onresult=function(e){for(var r={"final":!1,transcript:""},o=e.resultIndex,a=n._results,c=e.resultIndex;c<e.results.length;++c){var l=e.results[c][0].transcript;if(e.results[c].isFinal){r.final=!0,r.transcript=l;break}r.transcript+=l}a[o]=r,0!=i&&t(),s.Util.testAndCallThis(n._onResult,n,r,o,a,e)},r.onstart=function(e){n._listening=!0,n._lastStartTime=Date.now(),s.Util.testAndCallThis(n._onStart,n,e)},r.onend=function(t){e.clearTimeout(i),i=0,n._listening=!1,s.Util.testAndCallThis(n._onEnd,n,t)},r.onerror=function(e){s.Util.testAndCallThis(n._onError,n,e)},r.onaudioend=function(){r.continuous||t()}),r.continuous=this.continuous,r.interimResults=this.interimResults;var o=function(){var t="";return""!==n.lang?t=n.lang:"undefined"!=typeof e.document&&null!==e.document.documentElement&&""!==e.document.documentElement.lang&&(t=e.document.documentElement.lang),t}();r.lang=o,n._results=[],r.start()}},stop:function(){this._recognizer&&this._recognizer.stop()},cancel:function(){this._recognizer&&this._recognizer.abort()}});t.prototype._listening=!1,t.prototype._results=[],t.prototype.continuous=!1,t.prototype.lang="",t.prototype.interimResults=!1,Object.defineProperties(t.prototype,{listening:{get:function(){return this._listening}},results:{get:function(){return JSON.parse(JSON.stringify(this._results))}}});var n={ab:"abk",aa:"aar",af:"afr",sq:"sqi",am:"amh",ar:"ara",an:"arg",hy:"hye",as:"asm",ae:"ave",ay:"aym",az:"aze",ba:"bak",eu:"eus",be:"bel",bn:"ben",bh:"bih",bi:"bis",bs:"bos",br:"bre",bg:"bul",my:"mya",ca:"cat",ch:"cha",ce:"che",zh:"zho",cu:"chu",cv:"chv",kw:"cor",co:"cos",hr:"hrv",cs:"ces",da:"dan",dv:"div",nl:"nld",dz:"dzo",en:"eng",eo:"epo",et:"est",fo:"fao",fj:"fij",fi:"fin",fr:"fra",gd:"gla",gl:"glg",ka:"kat",de:"deu",el:"ell",gn:"grn",gu:"guj",ht:"hat",ha:"hau",he:"heb",hz:"her",hi:"hin",ho:"hmo",hu:"hun",is:"isl",io:"ido",id:"ind",ia:"ina",ie:"ile",iu:"iku",ik:"ipk",ga:"gle",it:"ita",ja:"jpn",jv:"jav",kl:"kal",kn:"kan",ks:"kas",kk:"kaz",km:"khm",ki:"kik",rw:"kin",ky:"kir",kv:"kom",ko:"kor",kj:"kua",ku:"kur",lo:"lao",la:"lat",lv:"lav",li:"lim",ln:"lin",lt:"lit",lb:"ltz",mk:"mkd",mg:"mlg",ms:"msa",ml:"mal",mt:"mlt",gv:"glv",mi:"mri",mr:"mar",mh:"mah",mo:"mol",mn:"mon",na:"nau",nv:"nav",nd:"nde",nr:"nbl",ng:"ndo",ne:"nep",se:"sme",no:"nor",nb:"nob",nn:"nno",ny:"nya",oc:"oci",or:"ori",om:"orm",os:"oss",pi:"pli",pa:"pan",fa:"fas",pl:"pol",pt:"por",ps:"pus",qu:"que",rm:"roh",ro:"ron",rn:"run",ru:"rus",sm:"smo",sg:"sag",sa:"san",sc:"srd",sr:"srp",sn:"sna",ii:"iii",sd:"snd",si:"sin",sk:"slk",sl:"slv",so:"som",st:"sot",es:"spa",su:"sun",sw:"swa",ss:"ssw",sv:"swe",tl:"tgl",ty:"tah",tg:"tgk",ta:"tam",tt:"tat",te:"tel",th:"tha",bo:"bod",ti:"tir",to:"ton",ts:"tso",tn:"tsn",tr:"tur",tk:"tuk",tw:"twi",ug:"uig",uk:"ukr",ur:"urd",uz:"uzb",vi:"vie",vo:"vol",wa:"wln",cy:"cym",fy:"fry",wo:"wol",xh:"xho",yi:"yid",yo:"yor",za:"zha",zu:"zul"};return t.convertLanguageToISO6392=function(e){var t=e.substring(0,2),s=n[t];return"undefined"==typeof s&&(s=e.substring(0,3)),s},t}(),s.support=function(e){var t={},n=!1,s=!1;Object.defineProperties(t,{localStorage:{get:function(){return n}},speechRecognition:{get:function(){return s}}});try{s=function(e){"use strict";e=e||{};var t=e.webkitSpeechRecognition||e.SpeechRecognition;return e.SpeechRecognition=t,"undefined"!=typeof t}(e)}catch(i){}try{n=function(e){"use strict";return e=e||{},"undefined"!=typeof e.Storage}(e)}catch(i){}return t}(e),s.Internal.setup(),s}(window,$,Faye);