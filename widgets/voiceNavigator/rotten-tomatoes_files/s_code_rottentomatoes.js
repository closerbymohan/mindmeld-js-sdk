...
var s_account="wbrosrottentomatoes"
...
s.linkInternalFilters="javascript:,admeld.com,rottentomatoes.com,www.facebook.com/plugins/like.php,rottentomatoes,www.rottentomatoes.com"
...
function s_doPlugins(s) {
	...
	s.campaign=s.getQueryParam('adid,promo,ref');
	...
	s.linkLeaveQueryString=true;  
      	...
      	if(url){        
          	tempadid=s.getQueryParam('adid','promo','ref',url)
          	if(tempadid){
	...
	s.prop14=s.eVar14=s.getTimeParting('h','-8','2013'); // Set hour 
	s.prop15=s.eVar15=s.getTimeParting('d','-8','2013'); // Set day
	s.prop16=s.eVar16=s.getTimeParting('w','-8','2013'); // Set Weekend / Weekday
